...
from pages import index, predictions, insights, proces, pagename
...
navbar = dbc.NavbarSimple(
    brand='What does it take to play in the NBA?',
    brand_href='/', 
    children=[
        dbc.NavItem(dcc.Link('Predictions', href='/predictions', className='nav-link')), 
        dbc.NavItem(dcc.Link('Insights', href='/insights', className='nav-link')), 
        dbc.NavItem(dcc.Link('Process', href='/process', className='nav-link')), 
        dbc.NavItem(dcc.Link('🐐's Only', href='/pagename', className='nav-link')), 
    ],
    sticky='top',
    color='light', 
    light=True, 
...
footer = dbc.Container(
    dbc.Row(
        dbc.Col(
            html.P(
                [
                    html.Span('Mikio Harman', className='mr-2'), 
                    html.A(html.I(className='fas fa-envelope-square mr-1'), href='mailto:mikioharman@gmail.com'), 
                    html.A(html.I(className='fab fa-github-square mr-1'), href='https://github.com/mpharm88/ds8_unit2_proj'), 
                    html.A(html.I(className='fab fa-linkedin mr-1'), href='https://www.linkedin.com/in/mikio-harman-6342a9195/'), 
                    html.A(html.I(className='fab fa-twitter-square mr-1'), href='https://twitter.com/harmanmikio'),
                ], 
                className='lead'
            )
        )
